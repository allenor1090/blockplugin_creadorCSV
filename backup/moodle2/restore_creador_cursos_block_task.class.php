...
/**
 * The task that provides a complete restore of block_creador_cursos is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/creador_cursos/backup/moodle2/restore_creador_cursos_stepslib.php');

/**
 * Restore task for block_creador_cursos.
 */
class restore_creador_cursos_block_task extends restore_block_task {
